...
OBJECTS += main.o
 ...
 SYS_OBJECTS += mbed/TARGET_LPC1549/TOOLCHAIN_GCC_ARM/board.o
 SYS_OBJECTS += mbed/TARGET_LPC1549/TOOLCHAIN_GCC_ARM/cmsis_nvic.o
 SYS_OBJECTS += mbed/TARGET_LPC1549/TOOLCHAIN_GCC_ARM/retarget.o
 SYS_OBJECTS += mbed/TARGET_LPC1549/TOOLCHAIN_GCC_ARM/startup_LPC15xx.o
 SYS_OBJECTS += mbed/TARGET_LPC1549/TOOLCHAIN_GCC_ARM/system_LPC15xx.o
...
INCLUDE_PATHS += -I../mbed/TARGET_LPC1549
INCLUDE_PATHS += -I../mbed/TARGET_LPC1549/TARGET_NXP
INCLUDE_PATHS += -I../mbed/TARGET_LPC1549/TARGET_NXP/TARGET_LPC15XX
INCLUDE_PATHS += -I../mbed/TARGET_LPC1549/TOOLCHAIN_GCC_ARM

LIBRARY_PATHS := -L../mbed/TARGET_LPC1549/TOOLCHAIN_GCC_ARM 
LIBRARIES := -lmbed 
LINKER_SCRIPT ?= ../mbed/TARGET_LPC1549/TOOLCHAIN_GCC_ARM/LPC1549.ld

# Objects and Paths
###############################################################################
# Tools and Flags

AS      = 'arm-none-eabi-gcc' '-x' 'assembler-with-cpp' '-c' '-Wall' '-Wextra' '-Wno-unused-parameter' '-Wno-missing-field-initializers' '-fmessage-length=0' '-fno-exceptions' '-fno-builtin' '-ffunction-sections' '-fdata-sections' '-funsigned-char' '-MMD' '-fno-delete-null-pointer-checks' '-fomit-frame-pointer' '-Os' '-DMBED_RTOS_SINGLE_THREAD' '-mcpu=cortex-m3' '-mthumb'
CC      = 'arm-none-eabi-gcc' '-std=gnu99' '-c' '-Wall' '-Wextra' '-Wno-unused-parameter' '-Wno-missing-field-initializers' '-fmessage-length=0' '-fno-exceptions' '-fno-builtin' '-ffunction-sections' '-fdata-sections' '-funsigned-char' '-MMD' '-fno-delete-null-pointer-checks' '-fomit-frame-pointer' '-Os' '-DMBED_RTOS_SINGLE_THREAD' '-mcpu=cortex-m3' '-mthumb'
CPP     = 'arm-none-eabi-g++' '-std=gnu++98' '-fno-rtti' '-Wvla' '-c' '-Wall' '-Wextra' '-Wno-unused-parameter' '-Wno-missing-field-initializers' '-fmessage-length=0' '-fno-exceptions' '-fno-builtin' '-ffunction-sections' '-fdata-sections' '-funsigned-char' '-MMD' '-fno-delete-null-pointer-checks' '-fomit-frame-pointer' '-Os' '-DMBED_RTOS_SINGLE_THREAD' '-mcpu=cortex-m3' '-mthumb'
LD      = 'arm-none-eabi-gcc'
ELF2BIN = 'arm-none-eabi-objcopy'
PREPROC = 'arm-none-eabi-cpp' '-E' '-P' '-Wl,--gc-sections' '-Wl,--wrap,main' '--specs=nano.specs' '-mcpu=cortex-m3' '-mthumb'


C_FLAGS += -std=gnu99
C_FLAGS += -DTARGET_LPC1549
C_FLAGS += -D__MBED__=1
...
C_FLAGS += -DMBED_BUILD_TIMESTAMP=1508814102.13
C_FLAGS += -DTARGET_LPC15XX
...
CXX_FLAGS += -DMBED_BUILD_TIMESTAMP=1508814102.13
CXX_FLAGS += -DTARGET_LPC15XX
...
ASM_FLAGS += -Imbed/.
ASM_FLAGS += -Imbed/TARGET_LPC1549
ASM_FLAGS += -Imbed/TARGET_LPC1549/TARGET_NXP
ASM_FLAGS += -Imbed/TARGET_LPC1549/TARGET_NXP/TARGET_LPC15XX
ASM_FLAGS += -Imbed/TARGET_LPC1549/TOOLCHAIN_GCC_ARM


LD_FLAGS :=-Wl,--gc-sections -Wl,--wrap,main --specs=nano.specs -mcpu=cortex-m3 -mthumb 
